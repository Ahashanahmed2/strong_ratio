...
# =========================================================
# CREATE STATIC FILES (Keep as is)
# =========================================================
# ... [Previous static file creation code remains the same] ...

def create_static_files():
    """Create all static files"""
    # Create manifest.json (keeping your existing code)
...
<body>
    <div class="container">
        <div class="container-main">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4 col-sm-6 mb-3">
                    <div class="stats-card"><p>⭐ Avg Strong Ratio</p><h3 id="avgStrongRatio">0.00</h3></div>
                </div>
                <div class="col-md-4 col-sm-6 mb-3">
            ...
            <div class="table-container">
                <table id="dataTable" class="table table-bordered table-hover">
                    <thead>
                        <tr><th>#</th><th>RT</th><th>BBR</th><th>Strong</th><th>Strong Ratio</th><th>Bullish Prob</th><th>Saved At</th><th>Actions</th></tr>
                    </thead>
            ...
            <div class="footer">
                <p>🚀 FastAPI + MongoDB | 📡 Auto-refresh every 3 min</p>
    ...
    <script>
        ...
        function getBullishClass(probability) {
            if (!probability || probability === 'N/A') return 'badge-neutral';
            let num = parseFloat(probability);
            if (num >= 60) return 'badge-bearish';
            if (num >= 45) return 'badge-neutral';
        ...
        function renderTable(data) {
            ...
            data.forEach((item, idx) => {
                ...
                let bullishClass = getBullishClass(item.bullish_probability);
                ...
                let row = `<tr>
                    ...
                    <td><span class="${bullishClass}">${item.bullish_probability || 'N/A'}</span></td>
                    <td><small>${savedDate}</small></td>
                    <td>
                        <button class="btn-delete" onclick="deleteRecord('${item.rt}')">🗑️ Delete</button>
                     </td>
                </tr>`;
                tbody.append(row);
            });
...
# Create static files before mounting
create_static_files()
...
async def get_data():
    ...
    try:
        ...
        for doc in documents:
            # Calculate strong ratio from 'strong' field
            strong_ratio = parse_strong_ratio(doc.get('strong'))
            
            # Calculate bullish probability from 'bbr' field
...
async def get_stats():
    ...
    # Calculate average strong ratio
...
if __name__ == "__main__":
    ...
    # Start keep-alive thread (only if not in debug mode)
